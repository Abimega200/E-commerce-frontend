...
const Home = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(
        "https://backened-3j0w.onrender.com/api/products/get"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://backened-3j0w.onrender.com/api/products/edit/${editProduct._id}`,
        formData
      );
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://backened-3j0w.onrender.com/api/products/delete/${id}`
      );
